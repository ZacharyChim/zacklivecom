...
const theme = createMuiTheme({
  base: {
    ...
    fonts: {
      unstyledFamily: `PingFangSC-Thin, PingFangSC, "Noto Sans", "Noto Sans CJK", "Source Han Sans", "Microsoft YaHei", "微软雅黑", STXihei, "华文细黑", "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif`
  ...
  typography: {
    fontFamily: `PingFangSC-Thin, PingFangSC, "Noto Sans", "Noto Sans CJK", "Source Han Sans", "Microsoft YaHei", "微软雅黑", STXihei, "华文细黑", "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif`,
    fontSize: 16
  },
  pallete: {
    action: {
